...
#./tfb --test quarkus-reactive-routes-pgclient helidon helidon-se-dbclient helidon-se-vertx-pg-client --type db
./tfb --test helidon helidon-se-dbclient --type plaintext --mode debug
#/home/kec/idp/wrk/wrk -H 'Host: localhost' \
# -H 'Accept: application/json,text/html;q=0.9,application/xhtml+xml;q=0.9,application/xml;q=0.8,*/*;q=0.7' \
# -H 'Connection: keep-alive' \
# -s toolset/wrk/pipeline.lua \
# --latency -d 15 -c 64 --timeout 8 -t 16 "http://localhost:8080/plaintext"
